    ...
    <div id="body-area">
      ...
      <div class="area-central">
        ...
        <div class="area-texto">
          <div align="justify">
            <h1>Novo Projeto</h1>
            <form id="frmPrincipal" action="${pageContext.request.contextPath}/projetos/add" method="post" class=".form-stacked">
              <div class="field">
                <div align="left">
                  Título
                </div>
                <input id="txtTitulo" type="text" class="righttextbox" name="projeto.titulo" />
              </div>
              ...
              <div class="field">
                ...
                <input id="txtDescricao" type="text" class="righttextbox" name="projeto.descricao" />
              </div>
              ...
              <div class="field">
                ...
                <input id="txtDataInicio" type="text" class="righttextbox" name="projeto.dataInicio" onkeypress="formatar(this, '##/##/####');"
                maxlength="10" />
              </div>
              ...
              <div class="field">
                ...
                <input id="txtDataFim" type="text" class="righttextbox" name="projeto.dataFim" onkeypress="formatar(this, '##/##/####');"
                maxlength="10" />
              </div>
              <br />
              <br />
              <div class="direito-texto field">
                <div align="center">
                  ...
                  <input type="submit" value="Salvar" class="btn primary login" />
                </div>
              </div>
            </form>
